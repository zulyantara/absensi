<?php
$startTimeStamp = strtotime($qry_cuti->ki_date_izin_1);
$endTimeStamp = strtotime($qry_cuti->ki_date_izin_2);
...
?>
<form class="uk-form uk-form-horizontal" method="post" action="<?php echo base_url("cuti/form_proses"); ?>">
    <input type="hidden" name="txt_divisi" value="<?php echo $divisi; ?>">
    <div class="uk-form-row">
        <label for="txt_npp" class="uk-form-label">NPP</label>
        <div class="uk-form-controls">
            <input type="text" placeholder="NPP" name="txt_npp" id="txt_npp" value="<?php echo $qry_cuti->ki_npp; ?>" readonly="readonly">
            <span class="uk-form-help-inline"><div class="uk-badge uk-badge-success"><?php echo $qry_cuti->karyawan_nama; ?></div></span>
        </div>
    </div>
    <div class="uk-form-row">
        <label for="txt_tgl_izin_1" class="uk-form-label">Hari / Tanggal Izin</label>
        <div class="uk-form-controls">
            <input type="text" placeholder="Tanggal Izin" name="txt_tgl_izin_1" id="txt_tgl_izin_1" value="<?php echo $qry_cuti->ki_date_izin_1; ?>" readonly="readonly">
            <input type="text" placeholder="Tanggal Izin" name="txt_tgl_izin_2" id="txt_tgl_izin_2" value="<?php echo $qry_cuti->ki_date_izin_2; ?>" readonly="readonly">
    ...
    <div class="uk-form-row">
        ...
        <div class="uk-form-controls">
            <input type="text" placeholder="Tanggal Approve" name="txt_tgl_approve_1" id="txt_tgl_approve_1" value="<?php echo $qry_cuti->ki_date_izin_1; ?>" data-uk-datepicker="{format:'YYYY-MM-DD'}">
            <input type="text" placeholder="Tanggal Approve" name="txt_tgl_approve_2" id="txt_tgl_approve_2" value="<?php echo $qry_cuti->ki_date_izin_2; ?>" data-uk-datepicker="{format:'YYYY-MM-DD'}">
    ...
    <div class="uk-form-row">
        ...
        <div class="uk-form-controls">
            <textarea name="txt_alasan" id="txt_alasan" cols="30" readonly="readonly"><?php echo $qry_cuti->ki_alasan; ?></textarea>
        </div>
    </div>
    <div class="uk-form-row">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#btn_kembali").click(function(){
            window.location.href='<?php echo base_url("cuti"); ?>';
        });
    });
</script>